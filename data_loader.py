...
#     """
#     train_dir = r"/projects/data/llmteam/safi/dl_course/assignment_2/data/inaturalist_12K/train"

#     transform_basic = transforms.Compose([
#         transforms.Resize((IMG_HEIGHT, IMG_WIDTH)),
#         transforms.ToTensor(),  # Converts and scales pixel values to [0,1]
#     ])
#     # Load the entire dataset with basic transformation
...
# def get_augmented_data(batch_size):
#     """
#     Load train data with augmentation for the training subset while using only basic preprocessing for the validation subset.
#     """
#     train_dir = r"/projects/data/llmteam/safi/dl_course/assignment_2/data/inaturalist_12K/train"
...
#     # Load the full dataset without transform to obtain consistent ordering.
...
#     train_dataset = TransformedSubset(base_dataset, train_indices, transform_train)
#     valid_dataset = TransformedSubset(base_dataset, valid_indices, transform_valid)
...
#     """
#     Load training and test data (test data comes from the given 'val' directory).
#     No augmentation is applied.
#     """
#     train_dir = r"/projects/data/llmteam/safi/dl_course/assignment_2/data/inaturalist_12K/train"
#     test_dir = r"/projects/data/llmteam/safi/dl_course/assignment_2/data/inaturalist_12K/val"
...
# def get_augmented_test_data(batch_size):
#     """
...
# def test_loader(loader_func, batch_size=4, loader_name="Loader"):
#     """
#     Helper function to test a given loader by iterating over one batch and printing some info.
#     """
#     try:
#         loader, _ = loader_func(batch_size) if "augmented" not in loader_func.__name__ else loader_func(batch_size)
...
#             # Optionally, print min/max to check the conversion
...
#     test_loader(get_data, batch_size=4, loader_name="get_data")
    
#     # Test get_augmented_data function
#     test_loader(get_augmented_data, batch_size=4, loader_name="get_augmented_data")
    
#     # Test get_test_data function
#     test_loader(get_test_data, batch_size=4, loader_name="get_test_data")
    
#     # Test get_augmented_test_data function
#     test_loader(get_augmented_test_data, batch_size=4, loader_name="get_augmented_test_data")
